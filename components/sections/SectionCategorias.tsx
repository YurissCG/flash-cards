...
// 12 categorias — grid grande demais (e demais em cima da dobra em conexões
// mais lentas) pra depender de scroll-reveal: fica em opacity:0 até o JS
// hidratar e o IntersectionObserver disparar, o que em rede real pode
// demorar e parecer que a seção não carregou. Renderiza direto, sem Reveal.
